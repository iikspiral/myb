...
@XmlType(name = "", propOrder = { "in0", "in1", "in2", "in3", "in4", "in5", "in6", "in7", "in8", "in9", "in10" })
...
public class Sms {
	...
	@XmlElementRef(name = "in9", namespace = "http://ws.flaginfo.com.cn", type = JAXBElement.class)
	protected JAXBElement<String> in9;
	@XmlElementRef(name = "in10", namespace = "http://ws.flaginfo.com.cn", type = JAXBElement.class)
	...
	public void setIn9(JAXBElement<String> value) {
		this.in9 = ((JAXBElement<String>) value);
	}
	...
	public void setIn10(JAXBElement<String> value) {
		this.in10 = ((JAXBElement<String>) value);
	}
