 ...
 * element interface generated in the com.sxca.ggzyzt.common.client.SmsService
 * package.
 * <p>
...
public class ObjectFactory {
	...
	private final static QName _ReplyResponseConfirmTime_QNAME = new QName("http://ws.flaginfo.com.cn", "confirm_time");
	private final static QName _ReplyResponseId_QNAME = new QName("http://ws.flaginfo.com.cn", "id");
	private final static QName _ReplyConfirmRequestIn4_QNAME = new QName("http://ws.flaginfo.com.cn", "in4");
	private final static QName _SmsIn10_QNAME = new QName("http://ws.flaginfo.com.cn", "in10");
	private final static QName _SmsIn9_QNAME = new QName("http://ws.flaginfo.com.cn", "in9");
	private final static QName _ReplyRequestIn3_QNAME = new QName("http://ws.flaginfo.com.cn", "in3");

	/**
	 * Create a new ObjectFactory that can be used to create new instances of
	 * schema derived classes for package:
	 * com.sxca.ggzyzt.common.client.SmsService
	 * 
	 */
	...
	public JAXBElement<String> createReplyResponseConfirmTime(String value) {
		return new JAXBElement<String>(_ReplyResponseConfirmTime_QNAME, String.class, ReplyResponse.class, value);
	}
	...
	public JAXBElement<String> createReplyResponseId(String value) {
		return new JAXBElement<String>(_ReplyResponseId_QNAME, String.class, ReplyResponse.class, value);
	}
	...
	public JAXBElement<String> createReplyConfirmRequestIn4(String value) {
		return new JAXBElement<String>(_ReplyConfirmRequestIn4_QNAME, String.class, ReplyConfirmRequest.class, value);
	}
	...
	public JAXBElement<String> createSmsIn10(String value) {
		return new JAXBElement<String>(_SmsIn10_QNAME, String.class, Sms.class, value);
	}
	...
	public JAXBElement<String> createSmsIn9(String value) {
		return new JAXBElement<String>(_SmsIn9_QNAME, String.class, Sms.class, value);
	}
	...
	public JAXBElement<String> createReplyRequestIn3(String value) {
		return new JAXBElement<String>(_ReplyRequestIn3_QNAME, String.class, ReplyRequest.class, value);
	}
