...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
	...
	public static String formatDateTime(Date date) {
	 ...
	 /**
     * 在线支付报文时间格式，转换格式（yyyyMMddHHmmss）
     */
	...
	public static Date parseDate(Object str) {
		...
		try {
			if (Pattern.matches("[0-9]{8}", (String)str)) {
				return parseDate((String)str, "yyyyMMdd");
			}
			if (Pattern.matches("[0-9]{12}", (String)str)) {
				return parseDate((String)str, "yyyyMMddHHmm");
			}
			if (Pattern.matches("[0-9]{14}", (String)str)) {
				return parseDate((String)str, "yyyyMMddHHmmss");
			}
