...
public class BeanValidators {
	...
	public static Map<String, String> getRegex() {
		Map<String, String> regexMap = new HashMap<String, String>();
		regexMap.put("email", Global.getConfig("regex.email"));
		regexMap.put("phone", Global.getConfig("regex.phone"));
		regexMap.put("zipCode", Global.getConfig("regex.zipCode"));
		regexMap.put("URL", Global.getConfig("regex.url"));
		return regexMap;
	}
	
	public static String getRegexEmail() {
		return getRegex().get("email");
	}
	
	public static String getRegexPhone() {
		return getRegex().get("phone");
	}
	
	public static String getRegexZipCode() {
		return getRegex().get("zipCode");
	}
	
	public static String getRegexURL() {
		return getRegex().get("URL");
	}
