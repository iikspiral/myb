 ...
 * @project rest_demo
 */
package com.sxca.myb.common.ucpaas.restDemo;

import com.sxca.myb.common.ucpaas.restDemo.client.AbsRestClient;
import com.sxca.myb.common.ucpaas.restDemo.client.JsonReqClient;
import com.sxca.myb.common.ucpaas.restDemo.client.XmlReqClient;
...
//		System.out.println(obj.getInt("client"));
		...
		if (method.equals("1")) {
			...
			String accountSid="3eb666b96c1eb92535a4c333c8e4a5ae";
			String token="619549c62ec48f66062b4405a519c57d";
			String appId="f8cd8d1c7a484a549aa4f4f2567e8186";
			String templateId="1";
			String to="15821460294";
			String para="测试短信";
