...
import com.sxca.myb.common.security.Digests;
import com.sxca.myb.common.security.shiro.session.SessionDAO;
import com.sxca.myb.common.service.BaseService;
import com.sxca.myb.common.service.ServiceException;
...
import com.sxca.myb.modules.sys.dao.MenuDao;
import com.sxca.myb.modules.sys.dao.RoleDao;
import com.sxca.myb.modules.sys.dao.UserDao;
...
import com.sxca.myb.modules.sys.security.SystemAuthorizingRealm;
...
public class SystemService extends BaseService implements InitializingBean {
	 ...
	 * @return
	 */
	public User getUserByCertSubject(String certsubject) {
		return UserUtils.getByCertSubject(certsubject);
	}
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	@Transactional(readOnly = false)
	public void updateCertSubById(String id, String loginName, String certsub) {
		User user = new User(id);
		user.setCertSubject(certsub);
		userDao.updateCertsubById(user);
		// 清除用户缓存
		user.setLoginName(loginName);
		UserUtils.clearCache(user);
//		// 清除权限缓存
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public static boolean printKeyLoadMessage(){
		...
		sb.append("\r\n======================================================================\r\n");
		sb.append("\r\n    欢迎使用 "+Global.getConfig("productName")+"  - Powered By http://com.sxca.cn\r\n");
		sb.append("\r\n======================================================================\r\n");
