...
import com.sxca.myb.modules.sys.service.OfficeService;
...
//		}
	...
	public String assign(Role role, Model model) throws UnsupportedEncodingException {
		if(role.getOffice() != null){
			role.getOffice().setName(URLDecoder.decode(role.getOffice().getName(), "UTF-8"));
		}
