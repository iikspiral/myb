...
<head>
	...
	function fenpei(id,name){
		window.location.href="${ctx}/sys/role/assign?id="+id+"&office.name="+encodeURI(encodeURI(name));
	}
	</script>
</head>
<body>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<tr><th>角色名称</th>
<!-- 		<th>英文名称</th> -->
		<th>归属机构</th><th>数据范围</th><shiro:hasPermission name="sys:role:edit"><th>操作</th></shiro:hasPermission></tr>
...
<!-- 				<td><a href="form?id=${role.id}">${role.enname}</a></td> -->
				...
				<shiro:hasPermission name="sys:role:edit"><td>
					<a  href="javascript:void(0)" onclick="fenpei('${role.id}','${role.office.name}')">分配</a>
