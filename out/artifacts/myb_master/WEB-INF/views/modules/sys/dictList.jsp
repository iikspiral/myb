...
<head>
	...
	<script type="text/javascript">
		...
		function keyClick(type,sort,description){
			window.location.href="${ctx}/sys/dict/form?type="+type+"&sort="+sort+"&description="+encodeURI(encodeURI(description));
		}
...
<body>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead><tr><th>键值</th><th>标签</th><th>类型</th><th>描述</th><th>是否扩展域字典</th><th>排序</th><shiro:hasPermission name="sys:dict:edit"><th>操作</th></shiro:hasPermission></tr></thead>
		<tbody>
		<c:forEach items="${page.list}" var="dict">
			<tr>
				...
				<td>${fns:getDictLabel(dict.isExa, 'is_required', '无')}</td>
				<td>${dict.sort}</td>
				<shiro:hasPermission name="sys:dict:edit"><td>
					...
					<a  href="javascript:void(0)" onclick="keyClick('${dict.type}','${dict.sort+10}','${dict.description}')">修改键值</a>
