				...
				if ($(menuId).length > 0){
					...
					$.get($(this).attr("data-href"), function(data){
						...
						$(menuId + " .accordion-inner a").click(function(){
							...
							return addTab($(this),true);//点击菜单刷新页面，高光伟
						});
						// 默认选中第一个菜单
						$(menuId + " .accordion-body a:first i").click();
						$(menuId + " .accordion-body li:first li:first a:first i").click();
	...
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				...
				<div class="brand"><span id="productName">${fns:getSystemName()}</span></div>
...
<!-- 					</li> -->
					<li id="userInfo" class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="${ctx}/sys/user/modifyCertsub" target="mainFrame"><i class="icon-wrench"></i>&nbsp;  修改证书</a></li>
							<li><a href="javascript:cookie('tabmode','${tabmode eq '1' ? '0' : '1'}');location=location.href">${tabmode eq '1' ? '关闭' : '开启'}页签模式</a></li>
<!-- 							<li><a href="${ctx}/oa/oaNotify/self" target="mainFrame"><i class="icon-bell"></i>&nbsp;  我的通知 <span id="notifyNum2" class="label label-info hide"></span></a></li> -->
						</ul>
					</li>
					<li><a href="${ctx}/clearLogout" title="退出登录">退出</a></li>
					<li>&nbsp;</li>
				</ul>
	    ...
	    <div class="container-fluid">
			...
			<div id="footer" class="row-fluid">
	            <%-- Copyright &copy; 2012-${fns:getConfig('copyrightYear')} ${fns:getConfig('productName')} - Powered By <a href="http://www.sxca.com.cn/" target="_blank">山西CA</a> ${fns:getConfig('version')} --%>
				${fns:getCopyRight()}
			</div>
		</div>
	</div>
