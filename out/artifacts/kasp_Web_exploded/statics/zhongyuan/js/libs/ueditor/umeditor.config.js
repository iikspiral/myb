...
(function () {
	...
	if(!fileaction) $.kd.kdAlert("文件上传服务器配置有误！");
	if(!fileserver) $.kd.kdAlert("文件存放路径配置有误！");
    ...
    window.UMEDITOR_CONFIG = {
        ...
        //图片上传配置区
        imageUrl: fileaction,             //图片上传提交地址
        imagePath: fileserver,                     		  //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
